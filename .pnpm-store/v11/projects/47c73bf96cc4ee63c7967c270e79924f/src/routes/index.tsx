...
import VisitsTodayPage from "@/pages/Default/Visits/VisitsTodayPage";
...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      },
      {
        ...
        element:  (
          <ModulePlaceholder
            moduleName="Doacoes"
            title="Lotes"
            description="Acompanhamento de lotes pasteurizados."
          />
        ),
      },
      {
      ...
      {
        path: "visitas",
        element: <VisitsSchedulePage />,
      },
      {
        path: "visitas/hoje",
        element: <VisitsTodayPage />,
      },
      {
