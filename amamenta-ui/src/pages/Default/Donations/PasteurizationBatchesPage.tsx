...
export default function PasteurizationBatchesPage() {
  ...
  useEffect(() => {
    ...
    async function loadAvailableRawMilk() {
      ...
      try {
        ...
        setAvailableRawMilkError("Não foi possível carregar os frascos aprovados para o lote.");
      } finally {
  ...
  async function loadBatches() {
    ...
    try {
      ...
      setError("Não foi possível carregar os lotes de pasteurização.");
    } finally {
      setLoading(false);
    }
  }
  ...
  function openBatch(batch: PasteurizationBatch) {
  ...
  return (
    <section className="pasteurization-batches">
      <header className="pasteurization-batches__header">
        ...
        <BrButton icon="plus" primary onClick={openCreateModal}>
          Novo Lote
        </BrButton>
      </header>
      ...
      <div className="pasteurization-batches__filters">
        <BrInput
          label="Buscar lote"
          placeholder="Filtrar por ID, código, operador ou status"
          value={search}
            ...
            {modalView === "details" && (
              <>
                <div className="pasteurization-batches__details">
                  ...
                  <p><strong>Observações:</strong> {selectedBatch.observations ?? "-"}</p>
                </div>

                {selectedBatch.microbiologyStatus === "PENDING" && (
            ...
            {modalView === "approve" && (
              <div className="pasteurization-batches__actions">
                ...
                <div className="pasteurization-batches__action-form">
                  <BrMessage
                    category="message"
                    message="Informe o volume final e a quantidade de frascos gerados para confirmar a aprovação."
                    status="info"
                    title="Aprovação"
                  />
                  <BrInput
            ...
            {modalView === "reject" && (
              <div className="pasteurization-batches__actions">
                ...
                <div className="pasteurization-batches__action-form">
                  <BrMessage
                    category="message"
                    message="A observação é obrigatória. Use um dos exemplos abaixo ou descreva o motivo com clareza."
                    status="warning"
                    title="Rejeição"
                  />
                  <div className="pasteurization-batches__chips">
                    <BrButton
                      ...
                      size="small"
                      type="button"
                      onClick={() => setRejectReason("Contaminação")}
                    >
                      Contaminação
                    </BrButton>
                    <BrButton
                      ...
                      size="small"
                      type="button"
                      onClick={() => setRejectReason("Falha microbiológica")}
                    >
                    ...
                    <BrButton
                      ...
                      size="small"
                      type="button"
                      onClick={() => setRejectReason("Inconsistência operacional")}
                    >
      ...
      >
        <div className="pasteurization-batches__modal">
          ...
          <BrMessage
            category="message"
            message="Selecione os frascos aprovados e informações operacionais do ciclo de pasteurização."
            status="info"
          ...
          <div className="pasteurization-batches__action-form">
            ...
            <BrTextarea
              label="Observações"
              placeholder="Observações operacionais do lote"
